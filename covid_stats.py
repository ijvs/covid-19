...
class DataToJson:
	...
	def __init__(this):
		this.url_mapa = "https://ncov.sinave.gob.mx/mapa.aspx"
	...
	def get_source_file_number(this):
		...
		try:
			return re.findall(r'Mapa.aspx\/(.+?)",',this.req.text)[0]
		except Exception as e:
			return ""		

	def get_stats(this):
		"""Return the formated data"""
		url = "https://ncov.sinave.gob.mx/Mapa.aspx/"+this.get_source_file_number()
